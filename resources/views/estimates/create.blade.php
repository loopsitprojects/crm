                    ...
                    <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
                        ...
                        <div class="p-6 space-y-5">
                            ...
                            <div>
                                ...
                                <input type="date" name="date_of_delivery" value="{{ old('date_of_delivery') }}"
                                    class="w-full rounded-md border-gray-300 focus:border-brand-blue focus:ring-brand-blue text-sm py-2">
                            </div>
                            ...
                            <div>
                                ...
                                <input type="text" name="place_of_supply" value="{{ old('place_of_supply') }}" placeholder="E.g. Colombo, Sri Lanka"
                                    class="w-full rounded-md border-gray-300 focus:border-brand-blue focus:ring-brand-blue text-sm py-2">
                            </div>
                        </div>
                    </div>
    ...
    <script>
        ...
        function addItem() {
            ...
            row.innerHTML = `
                ...
                <td class="p-2 align-top">
                    <input type="text" step="0.01" name="items[${rowCount}][unit_price]" required data-required="true" value="" placeholder="0.00" oninput="updateBasePrice(this); calculateRow(this)" class="w-full rounded-md border-gray-200 text-sm py-1 px-1 text-right">
                </td>
                <td class="p-2 align-top">
