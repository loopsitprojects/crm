...
@section('content')
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
                ...
                <div class="lg:col-span-2 space-y-8">
                    ...
                    <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
                        ...
                        <div id="third_party_costs_section" class="{{ ($estimate->third_party_cost ?? 'no') == 'no' ? 'hidden' : '' }} p-0 overflow-x-auto">
                    ...
                    <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
                        ...
                        <div class="p-6 space-y-5">
                            ...
                            <div>
                                ...
                                <input type="date" name="date_of_delivery" value="{{ old('date_of_delivery', $tempInvoice->date_of_delivery ?? ($estimate->date_of_delivery ?? '')) }}"
                                    class="w-full rounded-md border-gray-300 focus:border-brand-blue focus:ring-brand-blue text-sm py-2">
                            </div>
                            ...
                            <div>
                                ...
                                <input type="text" name="place_of_supply" value="{{ old('place_of_supply', $tempInvoice->place_of_supply ?? ($estimate->place_of_supply ?? '')) }}" placeholder="E.g. Colombo, Sri Lanka"
                                    class="w-full rounded-md border-gray-300 focus:border-brand-blue focus:ring-brand-blue text-sm py-2">
                            </div>
                        </div>
                    </div>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function () {
            @php
                $termsVal = $tempInvoice->terms ?: ($estimate->terms ?? '');
            @endphp
            @if($termsVal)
